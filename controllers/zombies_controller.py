...
def show_zombie(id):
    zombie = zombie_repository.select(id)
    list_of_victims = human_repository.humans_bitten_by_one_zombie(zombie)
    return render_template("/zombies/show.html", zombie=zombie, list_of_victims=list_of_victims)
